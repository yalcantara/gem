...
class NewRealmDialog extends React.Component{
    ...
    save(){
        ...
        var realm = {name: name, label: label};
        
        var self = this;
        //this.props refer to properties (babel) passed by React.
        var tenantId = this.props.crtTenant.id;
        rest.postAndGet('/rest/auth/tenants/ent/' + tenantId +'/realms', realm).then(function(res){
                ...
                <div className="modal-dialog modal-dialog-centered modal-sm" role="document">
                    <div className="modal-content">
                        <div className="modal-header" style={{height: '35px', paddingTop: '5px'}}>
                            <span className="modal-title">Create New Realm</span>
