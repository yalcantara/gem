class EditTenantDialog extends React.Component { 
    ...
    validate(){
        ...
        return validator.required(nameInput, nameMsg, 'The name is required.');
    }
    ...
    save() {
        ...
        var self = this;
        rest.putAndGet('/rest/auth/tenants/ent/' + id, ent).then(function(res){
                            ...
                            <form ref="form" style={{marginBottom: '5px'}}>
                                <div className="form-group">
                                    <label style={{width: '100%'}}>
                                        Tenant: <input ref="prevInput" className="form-control" type="text" disabled/>
                                    </label>
                                </div>
                                <div className="form-group">
                                    <label style={{width: '100%'}}>
